...
|------|-----------|----------------|------------------|--------|
| `AF_portfolio_light.png` | Hero | Интерфейс системы (светлая тема) — обзорная композиция консоли | [README.md](../../README.md) (главный визуал, без подписи — самодостаточен) | ✅ Актуален |
| `AF_portfolio_dark.png` | Hero | Интерфейс системы (тёмная тема) — обзорная композиция консоли | [ARCHITECTURE.md](../ARCHITECTURE.md) (главный визуал, без подписи — самодостаточен) | ✅ Актуален |
...
- **README** — светлый hero (`AF_portfolio_light.png`); тема GitHub по умолчанию светлая. Hero-скриншоты самодостаточны — подписи под ними не ставятся.
