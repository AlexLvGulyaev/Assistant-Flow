...
- **Access control:** evaluation write APIs must eventually sit behind the same **Admin API** protection model as the rest of the operational shell.
...
| Phase | Deliverable |
|-------|-------------|
| **P0 — Design lock-in** | This document. |
...
**Related backlog:** retrieval quality, metrics, experiments.
