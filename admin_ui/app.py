...
_EVENT_TYPE_RU: dict[str, str] = {
    ...
    "document_edit_started": "Редактирование canonical-текста начато",
    "document_edit_saved": "Редактирование canonical-текста сохранено",
    "document_reindex_started": "Переиндексация после правки запущена",
    "document_reindex_done": "Переиндексация после правки завершена",
    "document_reindex_error": "Ошибка переиндексации после правки",
...
def main() -> None:
    ...
    with tab_logs:
        ...
        with st.expander("Developer / Async jobs diagnostics", expanded=False):
